...
const options: swaggerJSDoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: version,
      description: 'A REST API for managing drone medication deliveries - Blusalt Engineering Challenge',
      contact: {
    ...
    components: {
      schemas: {
        Drone: {
          type: 'object',
          required: ['serialNumber', 'model', 'weightLimit', 'batteryCapacity', 'state'],
          properties: {
            id: {
              type: 'string',
        ...
        Medication: {
          ...
          properties: {
            ...
            name: {
              type: 'string',
              pattern: '^[a-zA-Z0-9\\-_]+$',
              description: 'Medication name (letters, numbers, hyphens, underscores only)',
            ...
            code: {
              type: 'string',
              pattern: '^[A-Z0-9_]+$',
              description: 'Medication code (uppercase letters, numbers, underscores only)',
              example: 'PARA_500'
            },
            image: {
              type: 'string',
